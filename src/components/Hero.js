    ...
    return (
        <div className="hero min-h-screen bg-base-500">
            <div className="hero-content rounded-lg border border-gray-500 p-8 flex flex-col sm:flex-row items-center justify-center">
                <div className="max-w-lg sm:mr-4 md:mr-6 lg:mr-8">
                    <h2 className="sm:text-1xl md:text-2xl lg:text-3xl text-center">Hello there, I am</h2>
                    <h1 className="sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center text-cyan-600 drop-shadow-[1px_1px_var(--tw-shadow-color)] shadow-yellow-500">Lamont Ng</h1>
                    <p className="sm:py-4 md:py-5 lg:py-6 text-center">
                        Inquisitive individual with a desire to learn more about the world, quick learner who assimilates
                        information rapidly, and strangely passionate about programming since it gives me a sense of
                        accomplishment upon successfully completing a code.
                    </p>
                    <p className="text-center sm:mb-3 md:mb-4 lg:mb-5">
                ...
                <img src={selfieImage} alt="Lamont" className="sm:w-72 md:w-80 lg:w-96 rounded-lg shadow-2xl mb-4 sm:mb-0" />
            </div>
        </div>
    );
};
